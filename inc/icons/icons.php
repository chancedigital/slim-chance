...
function include_svg_icons() {
	...
	$svg_icons = SLIM_CHANCE_IMG_PATH . 'svg-icons.svg';
...
function get_svg( $args = [] ) {
	...
	if ( empty( $args ) ) {
		return __( 'Please define default parameters in the form of an array.', 'slim-chance' );
	}

	// Define an icon.
	if ( false === array_key_exists( 'icon', $args ) ) {
		return __( 'Please define an SVG icon filename.', 'slim-chance' );
	}
